...
describe('Testing Image Processing Endpoints', function () {
    ...
    it('Testing render unexisting image', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get('/api/image?fileName=enaport').expect(401)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
    ...
    it('Testing Image Processing', function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
