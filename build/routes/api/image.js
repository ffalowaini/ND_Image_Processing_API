...
image.get('/', validateFileName_1.validateFileName, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, fileName, height, width, fullURL, res1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                fullURL = path_1.default.join(__dirname, '../../../assets/images/full/', "".concat(fileName, ".jpg"));
                if (!(width && height)) return [3 /*break*/, 2];
                console.log('widht & height valid');
                return [4 /*yield*/, (0, utilities_1.default)(fileName, Number(width), Number(height))];
            case 1:
                res1 = _b.sent();
                console.log('file name -> ' + (res1 === null || res1 === void 0 ? void 0 : res1.url));
